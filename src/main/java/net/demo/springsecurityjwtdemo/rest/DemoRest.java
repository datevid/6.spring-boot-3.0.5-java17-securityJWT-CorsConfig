package net.demo.springsecurityjwtdemo.rest;

import java.util.HashMap;
import java.util.Map;

import net.demo.springsecurityjwtdemo.model.AuthenticationReq;
...
import net.demo.springsecurityjwtdemo.model.TokenInfo;
import net.demo.springsecurityjwtdemo.service.JwtUtilService;
...
public class DemoRest {
  ...
  public ResponseEntity<TokenInfo> authenticate(@RequestBody AuthenticationReq authenticationReq) {
    ...
    UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(authenticationReq.getUsuario(),
